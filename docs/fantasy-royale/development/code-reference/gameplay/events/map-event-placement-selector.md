...
[BattleRoyaleExplorationPreviewDebug](../../playtest/battle-royale-exploration-preview-debug.md)がSceneの`PoolCandidate`をID入力へ変換し、PlanのIDを`MapEventPoolDefinition`とScene Markerへ戻す。`FixedDefinition` Socketはこの抽選を迂回する。
